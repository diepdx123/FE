          ...
          <div className="grid grid-cols-2 gap-8 mb-16">
            ...
            <div>
              ...
              <div className="mt-4 mb-8">
                ...
                <div className="flex gap-4">
                  <div className="bg-[#8160FA] w-[30px] h-[30px] rounded-full" />
                  <div className="bg-black w-[30px] h-[30px] rounded-full" />
                  <div className="bg-[#888E2F] w-[30px] h-[30px] rounded-full" />
                </div>
              </div>
              <div>
                <form action="">
                  ...
                  <button
                    type="submit"
                    className="border border-solid borde-yellow-600 text-yellow-600 rounded py-2 px-10 ml-3 hover:bg-yellow-600 hover:text-white"
                  >
                    Add To Cart
                  </button>
                  <button
